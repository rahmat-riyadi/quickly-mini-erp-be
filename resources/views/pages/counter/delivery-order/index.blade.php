                ...
                <table class="table table-hover table-bordered" >
                    ...
                    <tbody class="text-center" >
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: middle;" >{{ $item->do_number }}</td>
                            <td style="vertical-align: middle;" class="text-center" >{{ \Carbon\Carbon::parse($item->order_date)->translatedFormat('l, d F Y') }}</td>
                            <td style="vertical-align: middle;" class="text-center" >{{ $item->order_time }}</td>
                            <td style="vertical-align: middle;" class="text-center" >{{ is_null($item->delivery_date) ? '-' : \Carbon\Carbon::parse($item->delivery_date)->translatedFormat('l, d F Y') }}</td>
