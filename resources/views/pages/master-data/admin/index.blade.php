...
middleware(['auth']);
name('master-data.admin.index');

?>

<x-layouts.app subheaderTitle="Admin" >
    @volt
    <div class="container">
        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap border-0 pt-6 pb-0">
                <div class="card-title">
                    <h3 class="card-label">Daftar Admin</h3>
                </div>
                <div class="card-toolbar">
                    ...
                    <!--end::Dropdown-->
                    <!--begin::Button-->
                    <a href="/master-data/admin/form" wire:navigate class="btn btn-primary font-weight-bolder">
