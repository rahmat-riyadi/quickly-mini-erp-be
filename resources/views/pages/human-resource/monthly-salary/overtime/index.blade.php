...
middleware(['auth']);
name('human-resource.monthly-salary.overtime.index');
...
with(fn()=>[
    'data' => OvertimeMaster::when(!empty($this->keyword), function ($q) {
...
<x-layouts.app subheaderTitle="Data Master Lembur" >
    @volt
    <div class="container">
        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap border-0 pt-6 pb-0">
                <div class="card-title">
                    <h3 class="card-label">Daftar Lembur</h3>
                </div>
                <div class="card-toolbar">
                    ...
                    <!--end::Dropdown-->
                    <a href="/human-resource/monthly-salary/overtime/form" wire:navigate class="btn btn-primary font-weight-bolder">
            ...
            <div class="card-body">
                    ...
                    <tbody class="text-center" >
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="javascript:;" data-href="/human-resource/overtime/delete/{{ $item->id }}" onclick="deleteData(this, function(){ refresh() })"  class="btn btn-sm btn-light btn-icon mr-2" title="Delete">
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <div class="d-flex align-items-center py-3">
                        ...
                        <span class="text-muted">Menampilkan {{ $data->links()->paginator->count() }} dari {{  $data->links()->paginator->total() }} data</span>
                    </div>
                </div>
                <!--end: Datatable-->
            </div>
