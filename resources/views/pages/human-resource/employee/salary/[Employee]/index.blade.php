...
name('human-resource.employee.salary');
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">Mutasi Gaji</h3>
                </div>
                <div class="card-toolbar">
                    <a href="/human-resource/employee/salary/{{ $employee->id }}/form" wire:navigate class="btn btn-primary font-weight-bolder">
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th>Gaji Pokok</th>
                            <th>Hari Off</th>
                            <th>Intensive Kehadiran</th>
                            <th>Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($employee->salary as $i => $item)
                        <tr>
                            <td>{{ $i+1 }}</td>
                            <td>{{ "Rp ". number_format($item->base_salary) }}</td>
                            <td>{{ $item->time_off }}</td>
                            <td>{{ "Rp ". number_format($item->attendance_intensive) }}</td>
                            <td>
